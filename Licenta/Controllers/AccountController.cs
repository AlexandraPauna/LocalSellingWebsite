...
namespace Licenta.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register([Bind(Exclude = "UserPhoto")]RegisterViewModel model)
        {
            ...
            model.Cities = GetAllCities(); // Get cities again because we need this since IT'S NOT PASSED
            // as HTTP variable to the request
        ...
        public string DisplayCity()
        {
            ...
            string cityId = (user.CityId).ToString();
            string city = "";

            SqlConnection con = new SqlConnection(@"Data Source=(LocalDb)\MSSQLLocalDB;AttachDbFilename=C:\Users\HP\Desktop\Licenta\Licenta\App_Data\aspnet-Licenta-20181119051835.mdf;Initial Catalog=aspnet-Licenta-20181119051835;Integrated Security=True");
            string query = "SELECT * FROM City WHERE Id = " + cityId;
            //db.Entry(db.Cities).Reload();
